...
export  async function socialLoginApi(data){
  ...
  return await axios.post('http://127.0.0.1:8000/api/social/login', data
...
export  async function receiveCountryApi(){
  ...
  return await axios.get('http://127.0.0.1:8000/api/countries'
  )
  .then(function (response) {
    console.log(response)
    return response;
...
export  async function receiveStateApi(data){
  axios.defaults.headers.common["Authorization"] = `Bearer ${loadState().AuthReducer.access_token}`;
  console.log(data)
  return await axios.post('http://127.0.0.1:8000/api/states', data
  )
  .then(function (response) {
    console.log(response)
    return response;
...
export  async function receiveLGAsApi(data){
  axios.defaults.headers.common["Authorization"] = `Bearer ${loadState().AuthReducer.access_token}`;
  console.log(data)
  return await axios.post('http://127.0.0.1:8000/api/lgas', data
  )
  .then(function (response) {
    console.log(response)
    return response;
...
export  async function receiveKleanariesApi(){
  ...
  return await axios.get('http://127.0.0.1:8000/api/kleanaryitems'
  )
  .then(function (response) {
    console.log(response)
    return response;
...
export  async function receivePerfumesApi(){
  ...
  return await axios.get('http://127.0.0.1:8000/api/perfumes'
  )
  .then(function (response) {
    console.log(response)
    return response;
...
export  async function receiveStarchsApi(){
  ...
  return await axios.get('http://127.0.0.1:8000/api/starchs'
  )
  .then(function (response) {
    console.log(response)
    return response;
