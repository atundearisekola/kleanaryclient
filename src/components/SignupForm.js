  ...
  render() {
    ...
    const handlePassword = e => {
      ...
      if (e.target.value == this.state.password) {
        ...
        this.setState({ [name]: "Password does not Match" });
      }
    };
    return (
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              ...
              {this.state.confirmpass == "Password Matches" ? (
                <p className="text-success">{this.state.confirmpass}</p>
              ) : (
                ""
              )}
              {this.state.confirmpass == "Password does not Match" ? (
                <p className="text-info">{this.state.confirmpass}</p>
              ) : (
                ""
              )}
